    ...
    <div className="min-h-[calc(100vh-56px)] flex items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          {error && (
            <p className="text-sm text-red-400 mt-2">Authentication failed — please try again.</p>
          )}
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl bg-white text-gray-900 font-semibold hover:bg-gray-100 transition-colors"
          >
