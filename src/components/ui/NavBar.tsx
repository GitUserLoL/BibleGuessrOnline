    ...
    <header className="border-b border-white/5 backdrop-blur-sm sticky top-0 z-50 bg-[#080c18]/80">
      <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between">
        <Link
          ...
          className="font-black text-lg tracking-tight text-white hover:text-amber-300 transition-colors"
        >
          BibleGuessr
        </Link>
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="sm:hidden overflow-hidden border-t border-white/5 bg-[#080c18]"
          >
            <div className="max-w-5xl mx-auto px-4 py-1 flex flex-col">
              <Link
                href="/multiplayer"
                onClick={() => setMenuOpen(false)}
                className="py-3.5 text-sm text-white/60 hover:text-white transition-colors border-b border-white/5"
              >
                Multiplayer
              </Link>
              <Link
                href="/leaderboard"
                onClick={() => setMenuOpen(false)}
                className="py-3.5 text-sm text-white/60 hover:text-white transition-colors"
              >
                Leaderboard
              </Link>
            </div>
